<template>
  <LayoutComponent>
    ...
    <MultipleColumns />
    <ProductSlider :slide-per-view="4" :space-between="30" />
    <Information :classes="'flex md:flex-column'">
      <template v-slot:img>
      ...
      <template v-slot:content>
        ...
        <div class="t-informatiion__description">
          <p>
            Cung cấp dịch vụ vệ sinh xuất sắc làm cho ngôi nhà của bạn trở nên lấp lánh. Đội ngũ vệ
            sinh chuyên nghiệp của chúng tôi sử dụng các sản phẩm và kỹ thuật chất lượng cao nhất để
            đảm bảo không gian sống của bạn sáng bóng và sạch sẽ, làm cho ngôi nhà trở nên tươi sáng
            và thân thiện hơn."
          </p>
        </div>
    ...
    <Information :classes="'flex align-center flex-row-reverse'">
      ...
      <template v-slot:content>
        <h2>Giúp Thú Cưng Vui Chơi Và Tập Luyện</h2>
        <div class="t-informatiion__description">
          <p>
            Khám phá những hoạt động vui chơi và bài tập luyện thú vị giúp thú cưng của bạn luôn
            khỏe mạnh, năng động và không bị nhàm chán.
          </p>
        </div>
        <div class="t-information__button">
          <a href="" class="btn t-btn-primary">Đọc thêm</a>
...
import HomeSlider from '../components/slide/HomeSlider.vue'
